...
# Frametime, in seconds, for a button press. Since the display runs at ~50 fps,
# it gets tough to make precise time adjustments. This sets it to lower.
#
# 0.1 = 10fps for button presses.
BUTTON_PRESS_DURATION = 0.1

# User config for colours to use, and when.
COLOUR_CONFIG = {
    # Sunday
    0: [((0, 0), (0, 0, 0)), ((7, 30), (0, 128, 0)), ((7, 45), (0, 255, 0)),
        ((8, 0), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 255, 0)),
        ((18, 45), (0, 0, 0))],
    # Monday
    1: [((0, 0), (0, 0, 0)), ((7, 0), (0, 128, 0)), ((7, 5), (0, 255, 0)),
        ((7, 10), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 255, 0)),
        ((18, 45), (0, 0, 0))],
    # Tuesday
    2: [((0, 0), (0, 0, 0)), ((7, 0), (0, 128, 0)), ((7, 5), (0, 255, 0)),
        ((7, 10), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 255, 0)),
        ((18, 45), (0, 0, 0))],
    # Wednesday
    3: [((0, 0), (0, 0, 0)), ((7, 0), (0, 128, 0)), ((7, 5), (0, 255, 0)),
        ((7, 10), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 255, 0)),
        ((18, 45), (0, 0, 0))],
    # Thursday
    4: [((0, 0), (0, 0, 0)), ((7, 0), (0, 128, 0)), ((7, 5), (0, 255, 0)),
        ((7, 10), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 255, 0)),
        ((18, 45), (0, 0, 0))],
    # Friday
    5: [((0, 0), (0, 0, 0)), ((7, 0), (0, 128, 0)), ((7, 5), (0, 255, 0)),
        ((7, 10), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 0, 255)),
        ((18, 45), (0, 0, 0))],
    # Saturday
    6: [((0, 0), (0, 0, 0)), ((7, 30), (0, 128, 0)), ((7, 45), (0, 255, 0)),
        ((8, 0), (0, 0, 255)), ((11, 45), (0, 0, 0)), ((15, 0), (0, 255, 0)),
        ((18, 45), (0, 0, 0))]
}
...
class BackgroundFader(object):
    ...
    @staticmethod
    def lerp(ta, tb, t):
        return (BackgroundFader.clamp(int(ta[0] * (1 - t) + t * tb[0]), 0,
                                      255),
                BackgroundFader.clamp(int(ta[1] * (1 - t) + t * tb[1]), 0,
                                      255),
                BackgroundFader.clamp(int(ta[2] * (1 - t) + t * tb[2]), 0,
                                      255))
...
def main(bg_fader):
    ...
    while True:
        ...
        if utime.ticks_diff(utime.ticks_ms(),
                            last_button_check) >= 1000 * BUTTON_PRESS_DURATION:
            check_buttons()
        ...
        # Display fps
        frametime = utime.ticks_diff(utime.ticks_ms(), frame_start)
        instant_fps = 1000.0 / frametime

        display.set_pen(255, 255, 255)
        display.text("%f" % instant_fps, 255, 3, 0, 3)
